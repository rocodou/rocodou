...
class Login extends CI_Controller {
	...
	public function check()
	{
        ...
        if( $attempt=='valid' ){
            ...
            $this->data['message'] = 'Yanlış Şifre';
            ...
            $this->data['message'] = 'Giriş Yapılamadı Lütfen Sistem Yöneticisine Başvurun';
            $this->data['message_type'] = 'danger';
            ...
            $this->data['message'] = 'Birşeyler Ters Gitti!';
            $this->data['message_type'] = 'danger';
	...
	public function reset_password()
	{
		...
		if($reset==='invalid'){
			$this->data['message']	=	'Geçersiz Kullanıcı Adı / E-Posta';
			$this->data['message_type']	=	'danger';
		}
	...
	public function set_new_password()
	{
		...
		$this->session->set_flashdata('message', 'Şifreniz Değişti Lütfen Tekrar Giriş Yapın');
