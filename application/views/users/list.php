                ...
                <table id="example1" class="table table-bordered table-hover table-striped">
                  ...
                  <?php foreach ($users as $row): ?>
                    <tr>
                      ...
                      <td><?php echo ($row->last_login!='0000-00-00 00:00:00')?date( setting('date_format'), strtotime($row->last_login)):'Kayıt Yok' ?></td>
                      <td>
                      ...
                      <td>
                        ...
                        <?php if (hasPermissions('users_delete')): ?>
                          <?php if ($row->id!=1 && logged('id')!=$row->id): ?>
                            <a href="<?php echo url('users/delete/'.$row->id) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Bu Kullanıcıyı Silmek istediğinizden Emin misiniz  ?')" title="<?php echo lang('delete_user') ?>" data-toggle="tooltip"><i class="fa fa-trash"></i></a>
                          <?php else: ?>
