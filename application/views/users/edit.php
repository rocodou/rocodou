        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                ...
                <?php
                $selected= explode(',',$User->account_code);
                $option = $this->hesaplar_model->getListAccount();
                echo form_dropdown('account_code[]',$option,$selected,'multiple="multiple" class="select2" data-placeholder="Hesap Kodu Seçiniz" style="width: 100%;"');
                ?>
            </div>
